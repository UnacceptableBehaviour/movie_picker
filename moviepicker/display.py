...
class Player(QtWidgets.QMainWindow):
    ...
    def load_file(self, local_movie):
        # getOpenFileName returns a tuple, so use only the actual file name
        self.media = self.instance.media_new(local_movie)
        ...
        # Set the title of the track as window title
        self.setWindowTitle(local_movie.split('/').pop())
...
def display_test():
    ...
    # Docs - https://doc.qt.io/qt.html#qtforpython      NOTE this EG is QT5, QT6 also released
    # Creating a PyQt App - https://build-system.fman.io/pyqt5-tutorial

    # designate / load file
    # play / pause
    # stop / exit - S1
    # set volume according to 0-100 - slider control on web interface
    # position (use vol slider to test)
        #   get movie length
        #   position slider - S2
        # +30s / -30s
        # go to start
        # go to end (next track)
    # full screen
